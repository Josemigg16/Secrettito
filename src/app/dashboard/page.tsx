...
export default function Page() {
  ...
  return (
    <main
      className={`${BarlowCondensed.className} bg-ig h-screen overflow-hidden relative`}
    >
      <Header
        setLang={setLang}
        ...
        session={session}
      />
      <section className="mt-6 block h-[75%] grid-cols-8 md:mt-20 md:grid md:px-10 overflow-y-auto">
